...
<a href="https://my-aac.org">my-aac.org</a>'),
		...
		'shop_paypal_enabled' => [
			'name' => 'PayPal Top Up Enabled',
			'desc' => 'Enable buy points with PayPal on page /points',
			'type' => 'boolean',
			'default' => false,
		],
		'shop_paypal_email' => [
			'name' => 'PayPal Receiver E-Mail',
			'desc' => 'Primary PayPal e-mail that will receive payments',
			'type' => 'email',
			'default' => '',
		],
		'shop_paypal_mode' => [
			'name' => 'PayPal Mode',
			'desc' => 'Use sandbox for tests and live for production',
			'type' => 'options',
			'options' => ['sandbox' => 'Sandbox', 'live' => 'Live'],
			'default' => 'sandbox',
		],
		'shop_paypal_currency' => [
			'name' => 'PayPal Currency',
			'type' => 'options',
			'options' => ['USD' => 'USD', 'EUR' => 'EUR', 'BRL' => 'BRL', 'MXN' => 'MXN', 'CLP' => 'CLP', 'COP' => 'COP', 'PEN' => 'PEN'],
			'default' => 'USD',
		],
		'shop_paypal_packages' => [
			'name' => 'PayPal Packages',
			'type' => 'textarea',
			'desc' => 'One package per line in format: points=price (example: 100=3.99)',
			'default' => "100=3.99\n250=8.99\n750=24.99\n3000=89.99",
		],
		'donate_column' => [
			'name' => 'Donate Column',
