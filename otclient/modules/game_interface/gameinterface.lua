...
function show()
    ...
    if gameMapPanel:getHeight() > 0 then
        classicMapTileSize = gameMapPanel:getHeight() / 11
    end
...
function setupViewMode(mode)
    ...
    elseif mode == 2 then
        ...
        addEvent(function()
            if classicMapTileSize > 0 then
                gameMapPanel:setZoom(math.max(11, math.floor(gameMapPanel:getHeight() / classicMapTileSize + 0.5)))
            end
        end)
    end
