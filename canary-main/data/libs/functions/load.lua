...
dofile(CORE_DIRECTORY .. "/libs/functions/farming.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_build_enhancements.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_build_variant_guard.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_demolition.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_siege.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_siege_runtime.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_siege_supports.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_siege_interior.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_stair_floor_guard.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_catapult_v2.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_catapult_restore.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_floor_build.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_upper_floor_combat.lua")
dofile(CORE_DIRECTORY .. "/libs/functions/farming_ephemeral_structures.lua")
